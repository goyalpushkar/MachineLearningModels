...
class Net:
    ...
    def train(self, data, label):
        ...
        for b in range(batch_size):
            ...
            # print("x: \n", len(x), x.shape,  x.shape[0], x, "y: \n", len(y), y.shape, y.shape[0], y) # Pushkar
            # forward pass
...
"""
print('Loading data......')
sub_train_images, sub_train_labels, sub_test_images, sub_test_labels = init_subset('5569') # input your ASUID last 4 digits here to generate the subset samples of MNIST for training and testing
...
def evaluate(net, images, labels):
    ...
    # print("images", len(images), images.shape)   # images.shape[0]
    # print("labels", len(labels), labels.shape)   # labels.shape[0]
